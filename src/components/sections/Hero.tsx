    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-6 md:px-8">
        ...
        >
          ...
          >
            I spent 10 years saying no to companies.{" "}
            <span className="text-gradient">Now I help them become impossible to ignore.</span>
          </motion.h1>
          ...
          >
            Strategy & AI for businesses ready to scale. No fluff. No buzzwords. Just results.
          </motion.p>
